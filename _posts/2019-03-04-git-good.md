...
The article is bit long, but everyone loves efficiency right? Seriously, it's worth your time if you frequently work on software in a group setting.
...
These commands will get you going. If you're just working by yourself and not really doing anything fancy, you should be able to get by with jsut these 5:
...
If you're trying to follow the git workflow model, you'll probably need these commands...
